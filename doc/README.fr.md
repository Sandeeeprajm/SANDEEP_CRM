...
1.[Comment Contribuer](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#how-to-contribute)

2.[Signaler des problèmes](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#reporting-issues)

3.[Travailler sur des problèmes](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#working-on-issues)

4.[Soumettre des pull requests](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#submitting-pull-requests)

5.[Directives de commit](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#commit-guidelines)

6.[Directives de codage](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#coding-guidelines)

7.[Questions](https://github.com/sandeep/sandeep-erp-crm/blob/master/CONTRIBUTING.md#questions)
